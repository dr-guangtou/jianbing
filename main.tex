...
%% Trends with scatter
%% ---------------------------------------------------------------------------------------------- %%
\subsection{\sighalo{} from the ``Top N'' Tests}
    ...
    Using the scheme of the ``Top N'' tests, we 
...
\subsubsection{Scatter of \mvir{} at Fixed Observables}
    ...
    \begin{itemize}
        ...
        \item In the upper panel, we compare the results of a few representitive \mvir{} proxies 
            based on different principles.
            This includes \mcmodel{}, \maper{100}, \menve{50}{100}, $M_{\rm vir,\ ASAP}$, and the 
            HSC \redm{} richness.
            \plan{Outer envelope \mstar{} is better than large aperture \mstar{}, is much better 
            than \cmodel{}. Replacing \maper{100} with \maper{150} or \mmax{} does not change anything.}
        
        \item \plan{\sighalo{} seems to decrease with number density thresholds, suggesting a
            non-constant scatter along the SHMR at high-mass end.}
        
        \item \plan{\asap{} model: the prediction is pretty good, but not as good as we hoped. 
            Explain why, and how to improve}
        
        \item \plan{Middle panel: we compare different aperture \mstar{}; The inner 30-50 kpc of 
            massive galaxies really do not care about \mvir{} as the outskirt does.}
        
        \item \plan{Bottom panel: we compare a few different definitions of outskirt \mstar{}.
            Reinforce the conclusion that outskirt really care about \mvir{}.
            And that, given the current data quality of HSC, extending beyond 100 kpc does not 
            further improve the result. This is worth further exploration using even better data.}
