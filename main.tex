...
\section{Sample and Data Analysis}
    \label{sec:data}
\aph{It's sort of disruptive to the flow of the paper to have this section in between \S\ref{sec:method} and \S\ref{sec:data}. Would it be viable to switch the order of these two sections?} 
...
\section{Results}
    ...
    the observable}.
    2) All the \sigmh{} values should be treated in a relative sense. \aph{Maybe the rest of what follows can be relocated to a Caveats section at the end?} We adopt strong
