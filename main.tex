...
\subsubsection{Scatter of \mvir{} at Fixed Observables}
    ...
    \begin{itemize}
        ...
        \item Using the ``Top N'' tests, we confirm that the richness of red-sequence galaxie is indeed 
            ...
            that is challenging for any ``cluster'' finder and it has not been thoroughl vetted.
        ...
        \item In the top panel of Figure \ref{fig:scatter_trend}, we show that the \asap{} model 
            ...
            phenomelogical model like \asap{} by focusing on outer stellar halo such as between
            50 to 100 kpc.
