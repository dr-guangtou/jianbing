...
\section{Methodology}
    ...
    N-body simulation.
    We will first introduce a series of \mstar{}- (\ref{sec:sec:proxy_mstar}) and richness-based 
    (\ref{sec:sec:proxy_richness}) \mvir{} tracers.
...
We now perform the top N test. This consists of rank order various quantities and comparing
$\Delta\Sigma$ at fixed number density. Figure \ref{fig:density_bins} shows the number density
bins. Is Figure \ref{fig:fitting} necessary here? Maybe we can consolidate figures here.
