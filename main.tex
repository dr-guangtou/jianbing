...
\subsection{Impact of Satellites}
    ...
    \begin{itemize}
        ...
        \item We want to emphais that satellite fraction at high-mass end and their lensing 
            signals contain ample informatino about galaxy formatin process and galax-halo 
            connection. 
            \plan{We aim to constrian satellite fraction better with more complete spec-$z$ and
...
\subsubsection{Performance of \mcmodel{}}
    ...
    \begin{itemize}
        ...
        \item In the left panels of Figure \ref{fig:m100_cmod}, we compare the \rdsigma{} profiles
            ...
            Using the best-fit profils as reference (grey shaded region), we can see that the 
...
%% ---------------------------------------------------------------------------------------------- %%
\subsubsection{Performance of the \mstar{} of outer enevelope}
    \label{sec:moutskirt}
...
\subsubsection{Scatter of \mvir{} at Fixed Observables}
    ...
    \begin{itemize}
        ...
        \item In the upper panel, we compare the representitive \mvir{} proxies from several different 
            ...
            model ($M_{\rm vir,\ ASAP}$), and the richness of red-sequence galaxies 
            ($\lambda_{\rm redM,\ HSC}$).
        ...
        \item As already highlighted in Section \ref{sec:cmodel}, \maper{100} is clearly a much better 
        ...
        \item From these comparisons, we reinforce two important conclusions.
            Firstly, when the imaging quality allows, \mstar{} out to large physical aperture or just 
            in the very outskirt of massive galaxies can serve as a better \mvir{} proxy to study 
            galaxy-halo connection than \mstar{} based on default photometry. 
            ...
            single-\ser{} model can still have systematic issues at different levels for massive galaxies.
            We will investigate into these issues in future works.
        ...
        \item To further demonstrate the second point, we compare the results for different aperture \mstar{}
            and different outskirt \mstar{} in the middle and bottom panels of Figure \ref{fig:}.
            For aperture \mstar{}, the \sighalo{} at fixed number density significantly decreases with 
            increasingly large aperture value, especially in Bin 1 & 2.
            For Bin 1, \sighalo{} decreases from \todo{XX} for \maper{10 kpc}, and \todo{XX} for 
            \maper{30}, to \todo{XX} for \maper{100} (green dashed line as reference).
            The \sighalo{} values for \maper{10} and \maper{30} do not decrease with volume number 
            density as well.
        ...
        \item In the top panel of Figure \ref{fig:fig:scatter_trend}, we can also see that the 
            \mvir{} prediceted by the \asap{} model that is based on two aperture \mstar{}
            (\maper{10} and \mmax{} in this version).
            Its performance 
        
        \item \plan{\asap{} model: the prediction is pretty good, but not as good as we hoped. 
            Explain why, and how to improve
        
        \item \plan{Richness selected clusters have very good performance in Bin 1-2, but become 
            comparable to the \mstar{}-based proxies at higher number density bins.
            SDSS \redm{} and HSC \camira{} also support this conclusion.
            Need to compare with a few previous calibrations of \mvir{}-richness relation while
            making it clear that here the \sighalo{} is the scatter within the entire bin.}
        
        \item \plan{Summary: Be careful with \cmodel{}; Outskirt \mstar{} is really promising
            (with a few caveats)}.
