...
\subsection{The $\Delta\Sigma$ Profiles of \mstar{} and Richness Selected Samples}
    ...
    Different from these above works, we do not attempt to re-calibrate \mvir{}-richness relations.
    In stead, we focus on two questions:

    \begin{enumerate}
        \item What is the difference between the \dsigma{} profiles of massive halos selected 
            by richness and \mstar{} within the same volume number density range
    \end{enumerate}
